...
<html lang="el">
    ...
    <![endif]-->
     ...
     include('connection.php');
         $sql = "select * from position p, company c where p.company_id=c.company_id and p.approved=1 and p.posted=0";  
          ...
          <div class="box">
           <p style="font-weight: bold;">Τίτλος Θέσης Εργασίας:</p>
            ...
            <?php
             ...
             <br> <br>
             <!-- only for users -->
            <input type="submit" id="btn" value="Επεξεργασία" name = "submit"/> 
            </div> 
           <br> <br>
           <?php
           }
          }      else {
          echo "Δεν υπάρχουν αποθηκευμένες θέσεις";
          }
          ?>
        </div>
   </div>
