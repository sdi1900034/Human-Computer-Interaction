...
<header>
  <div class="container">
    <div class="row">
      ...
      <div class="grid_5">
        <div class="autor"><span> </span><i class="fa-solid fa-globe"></i><a href="#"><span1>  </span1>English</a><span>  </span><a href="#">Επικοινωνία</a><span>  </span><a href="profil_company.php?user=$username"><i class="fa-solid fa-user"></i> Προφίλ</a><span> </span> <i class="fa-solid fa-magnifying-glass"></i></a></div><spam>
      </div>
    </div>
  </div>
...
<div class="content">
  <div class="container">
   ...
   <div class="row">
    ...
    <!-- <center> -->
     <div class="grid_5">
      <h3><i class="fa-solid fa-pen-to-square"></i> Επεξεργασία Στοιχείων</h3>
       <!-- <div class="box1"> -->
         <div id="form">
          <form name="form" action="update_company_s.php?user=$username" onsubmit="return isvalid()" method="POST">
            <label> Όνομα:  </label>
            <input type="text" id="usern" name="usern"> <br> <br>
            <label> Επώνυμο: </label>
            <input type="text" id="sur" name="sur"> <br> <br>
            <label> Όνομα Φορέα: </label>
            ...
            <input type="reset" id="btn" value="Αλλαγή" name = "submit"/>
          </form>
         </div>
       </div>
   </div>
