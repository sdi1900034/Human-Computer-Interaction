    ...
    <![endif]-->
     ...
     include('connection.php');
      ...
      if(isset($location)&&isset($date)&&isset($duration)&&isset($fpu)){
        $sql = "select * from position p, company c where p.pos_title='$titlep' and p.location='$location' and p.startdate<='$date' and p.duration ='$duration'
...
<header>
  <div class="container">
    <div class="row">
      ...
      <div class="grid_5">
        <div class="autor"><span> </span><i class="fa-solid fa-globe"></i><a href="#"><span1>  </span1>English</a><span>  </span><a href="#">Επικοινωνία</a><span>  </span><a href="#"><a href="#"><i class="fa-solid fa-user"></i> Προφίλ</a><span> </span><a href="index.php"><span> </span> <a href="#"><i class="fa-solid fa-magnifying-glass"></i></a></div><spam>
      </div>
    </div>
  </div>
...
<div class="content">
  <div class="container">
   <div class="row">
   <form name="form" action="app_form.php" onsubmit="return isvalid()" method="get">
    <div class="grid_10">
    <h3> Αποτελέσματα : </h3>
     <?php
