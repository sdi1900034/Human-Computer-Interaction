...
$why=$_POST['mytext'];    
$sql="UPDATE `application` SET stage='Απορρίφθηκε', why='$why' WHERE `application_id`= $id";
$result = mysqli_query($conn, $sql);
if ($result){
    header("Location: com_app_control.php?msg1=Record rejected successfully");
}
else{
...
<div class="mb-3">
  <label for="exampleFormControlTextarea1" class="form-label">Εξηγήστε τους λόγους απόρριψης</label>
  <textarea class="form-control" id="exampleFormControlTextarea1" name="mytext" rows="3"></textarea>
</div>
