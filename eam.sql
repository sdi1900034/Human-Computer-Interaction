...
-- Χρόνος δημιουργίας: 23 Ιαν 2023 στις 12:21:50
...
(111, 'software engineer', 'Εγγεκριμένη', 0, 1900034, '2', 'sample.txt', 'new text', 'Γιατι..'),
(222, 'software engineer', 'Εγγεκριμένη', 0, 1900034, '2', 'sample.txt', 'new text', 'Γιατι..');
