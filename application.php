...
<div class="content">
  ...
  <div class="container">
    ...
    <div class="mb-3 row">
    <label for="staticName" class="col-sm-2 col-form-label">Τίτλος Θέσης</label>
    <div class="col-sm-10">
      <input type="text" readonly class="form-control-plaintext" id="staticName" value="<?php echo $row['position_name']; ?>">
    </div>
    </div>
    ...
    <div class="col-sm-10">
      <input type="text" readonly class="form-control-plaintext" id="staticName" value="<?php echo $row1['NAME']; ?> <?php echo $row1['SURNAME']; ?>">
    </div>
    </div>
    ...
    <div class="col-sm-10">
      <input type="text" readonly class="form-control-plaintext" id="staticEmail" value="<?php echo $row1['EMAIL']; ?>">
    </div>
    </div>

    <div class="mb-3 row">
    <label for="staticFilename" class="col-sm-2 col-form-label">Αναλυτική Βαθμολογία</label>
    <div class="col-sm-10">
       <input type="text" readonly class="form-control-plaintext" id="staticFilename" value=" <?php echo $row['file']; ?>">
    </div>
    </div>

    <div class="mb-3">
    <label for="exampleFormControlTextarea1" class="form-label">Σύντομη Παράγραφος (Γιατί αυτή τη θέση;)</label>
    <textarea type="text" readonly class="form-control-plaintext" id="staticFilename" ><?php echo $row['paragraph']; ?></textarea>
    </div>

    <div class="mb-3 row">
    <label for="staticStage" class="col-sm-2 col-form-label">Κατάσταση</label>
    <div class="col-sm-10">
      <input type="text" readonly class="form-control-plaintext" id="staticStage" value="<?php echo $row['stage']; ?>">
    </div>
    </div>

    <a href="com_app_control.php" class="btn" ><i class="fa-solid fa-angle-left"></i> Πίσω</a>
    <!--/form-->
    </tr>
    </tbody>
