   ...
   <div class="row">
     <div class="grid_5">
      ...
      <p class="p1">
        ...
        Αριθμός Μητρώου:<?php echo $AM[$num]. "\n"; ?> <br> <br>
        Τηλέφωνο: <?php echo $phone[$num]. "\n"; ?> <br> <br>
        Email: <?php echo  $email[$num]. "\n"; ?><br> <br>
        <a href="updating_student.php" class="btn">Επεξεργασία</a>
     </p>
     <?php
           }
          ?>
    ...
    <!-- <div class="box"> -->
     ...
     ?>
      <a href="search_pa_user.php" class="btn"><i class="fa-solid fa-magnifying-glass"></i>  Αναζήτηση Πρακτικής Άσκησης</a> <br>
      <a href="std_app_control.php?id=<?php echo $row['student_id'] ?>" class="btn"> <i class="fa-solid fa-list"></i>  Οι αιτήσεις μου</a> <br>
