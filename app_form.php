<?php
 ...
 if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO `application` (`application_id`, `position_name`, `stage`, `student_id`, `position_id`, `file`, `paragraph`) 
    VALUES ('11004', 'Programer, Intercom', 'Εκκρεμής', 'Alexandra Kopalidi', '2', '$myfile', '$mytext');";
...
<div class="content">
  ...
  <div class="container">
    ...
    <textarea class="form-control" name="FormText" rows="3"></textarea>
    </div>

    <button type="submit" class="btn btn-success" name="submit">Αποθήκευση</button>
    </form>
  </div>
